...
![YouTube Trending Page](_support files/airbnb.png)
...
![YouTube Trending Page](_support files/milano.jpg)
...
* at the following [link](http://htmlpreview.github.io/?https://github.com/peterhontaru/AirBnb-Milano-Price-Prediction/blob/master/AirBnb-Milan.html)
* md document
* in the **Exploratory-Data-Analysis.md** of this repo (however, I recommend previewing it at the link above since it is rendered as html)
